...
public class GenericGiniSplitter implements NodeSplitter{
	...
	public int getBest_attribute() {
		return best_attribute;
	}

	public double getBest_threshold() {
...
//        if(Double.isNaN(query.getData()[best_attribute])){
//            System.out.println("------ predict isnan --------");
//        }
	...
	public double getattr(TimeSeries query) {
//	    if(Double.isNaN(query.getData()[best_attribute])){
//            System.out.println("------ getattr isnan --------");
//            System.out.println(best_attribute);
//            for(double xx: query.getData()){
//                System.out.print(xx+",");
//            }
//            System.out.println(" ");
//        }
		return query.getData()[best_attribute];
	}
