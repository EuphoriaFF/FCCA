...
//	public long erp_count;	
	...
	public void printResults(String datasetName, int experiment_id, String prefix, String rootResult) {
...
//		System.out.print(", " + mean_weighted_depth_per_tree);
		...
		try  {
			BufferedWriter out = new BufferedWriter(new FileWriter(rootResult + datasetName + "-result.txt"));
			out.write(pre + datasetName+"\n");
			out.write("accuracy:" + accuracy+"\n");
			out.write("Training Time: " + elapsedTimeTrain /AppContext.NANOSECtoMILISEC + " ms"+"\n");
			out.write("Prediction Time: " + elapsedTimeTrain /AppContext.NANOSECtoMILISEC +
					elapsedTimeTest /AppContext.NANOSECtoMILISEC + " ms"+"\n");
			out.write("ALL Time: " + elapsedTimeTest /AppContext.NANOSECtoMILISEC + " ms"+"\n");
			out.write("mean_depth: " + mean_depth+"\n");
			out.close();
		}catch (IOException e){
