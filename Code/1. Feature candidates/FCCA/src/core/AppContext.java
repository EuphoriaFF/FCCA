...
public class AppContext {
	...
	public static String feature_save_file;
	...
	//public static boolean boosting = true;
	...
	public static int sax_splitters_per_node;
	...
	public static boolean sax_enabled = false;
...
//	public static boolean boss_use_gini_split = false;
	...
	public static RifFilters rif_components = RifFilters.ACF_PS_separately;
	...
	//SAX
	public static int sax_trasformations=1000;
    ...
    private static transient TSDataset validate_data;
    ...
    public static void setValidate_data(TSDataset validate_data) {
        AppContext.validate_data = validate_data;
    }
